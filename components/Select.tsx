  ...
  return (
    <div className="relative w-full">
      <div
        ...
        className="
          w-full
          px-[30px] py-2  border border-gray-300 rounded-lg
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-full bg-white border border-[#FF922B]  rounded-lg z-10 overflow-hidden">
          {options.map((opt) => (
            <div
              key={opt}
              onClick={() => {
              ...
              className={`px-4 py-2 cursor-pointer hover:bg-[#FF922B] hover:text-white text-[#222222] ${
                opt === value ? "bg-[#FF922B] text-white" : ""
              }`}
            >
              {opt}
            </div>
